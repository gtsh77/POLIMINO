...
export class f_cr {
	...
	public figure(type: string): string {
		...
		if(type === 'a'){
			...
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(0).addClass(`figure_block`).data('type','e').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(1).addClass(`figure_block`).data('type','e').data('row',1).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(2).addClass(`figure_block`).data('type','e').data('row',1).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(12).addClass(`figure_block`).data('type','e').data('row',2).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(13).addClass(`figure_block`).data('type','e').data('row',2).data('column',2).attr('figure',`${hash}`);		
		}
		else if(type === 'e2'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(0).addClass(`figure_block`).data('type','e2').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(1).addClass(`figure_block`).data('type','e2').data('row',1).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(2).addClass(`figure_block`).data('type','e2').data('row',1).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(13).addClass(`figure_block`).data('type','e2').data('row',2).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(14).addClass(`figure_block`).data('type','e2').data('row',2).data('column',3).attr('figure',`${hash}`);		
		}
		else if(type === 'f'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			...
			$('.block').eq(0).addClass(`figure_block`).data('type','g').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(12).addClass(`figure_block`).data('type','g').data('row',2).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(24).addClass(`figure_block`).data('type','g').data('row',3).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(25).addClass(`figure_block`).data('type','g').data('row',3).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(26).addClass(`figure_block`).data('type','g').data('row',3).data('column',3).attr('figure',`${hash}`);		
		}
		else if(type === 'k'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			...
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(0).addClass(`figure_block`).data('type','m').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(1).addClass(`figure_block`).data('type','m').data('row',1).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(2).addClass(`figure_block`).data('type','m').data('row',1).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(3).addClass(`figure_block`).data('type','m').data('row',1).data('column',4).attr('figure',`${hash}`);
			$('.block').eq(14).addClass(`figure_block`).data('type','m').data('row',2).data('column',3).attr('figure',`${hash}`);		
		}
		else if(type === 'm2'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(0).addClass(`figure_block`).data('type','m2').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(1).addClass(`figure_block`).data('type','m2').data('row',1).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(2).addClass(`figure_block`).data('type','m2').data('row',1).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(3).addClass(`figure_block`).data('type','m2').data('row',1).data('column',4).attr('figure',`${hash}`);
			$('.block').eq(13).addClass(`figure_block`).data('type','m2').data('row',2).data('column',2).attr('figure',`${hash}`);		
		}
		else if(type === 'n'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(0).addClass(`figure_block`).data('type','n').data('row',1).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(12).addClass(`figure_block`).data('type','n').data('row',2).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(13).addClass(`figure_block`).data('type','n').data('row',2).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(14).addClass(`figure_block`).data('type','n').data('row',2).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(26).addClass(`figure_block`).data('type','n').data('row',3).data('column',3).attr('figure',`${hash}`);		
		}
		else if(type === 'n2'){
			//стартовая позиция, зададим клеткам ид сущности, тип фигуры и номер строки
			$('.block').eq(2).addClass(`figure_block`).data('type','n2').data('row',1).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(12).addClass(`figure_block`).data('type','n2').data('row',2).data('column',1).attr('figure',`${hash}`);
			$('.block').eq(13).addClass(`figure_block`).data('type','n2').data('row',2).data('column',2).attr('figure',`${hash}`);
			$('.block').eq(14).addClass(`figure_block`).data('type','n2').data('row',2).data('column',3).attr('figure',`${hash}`);
			$('.block').eq(24).addClass(`figure_block`).data('type','n2').data('row',3).data('column',1).attr('figure',`${hash}`);		
		}
		else {}
